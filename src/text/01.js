...
// 设置左右按钮居中（图片高度-箭头高度）/2不准确
lfspan.style.top=500+'px';
rfspan.style.top=(parseInt(pop.offsetHeight)-20)/2+'px';
...
newsbigdiv.style.left=(content_width-divsv.length*20)/2+'px';
// 默认第一个为高亮
